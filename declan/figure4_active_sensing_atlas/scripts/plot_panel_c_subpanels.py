...
- `C2_accuracy_ordering`: known-eye, zero-eye, and joint-eye accuracy across
...
- `C5_scale_gap_guardrail`: joint-zero rescue range across priors and
  likelihood scales.
...
usable image-identification strategy. Compact projection results are a
