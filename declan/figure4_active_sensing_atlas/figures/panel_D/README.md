# Panel D Generated Assets

- `D1_local_axis_schematic.png`
- `D1_local_axis_schematic.pdf`
- `D2_axis_conditioned_accuracy.png`
- `D2_axis_conditioned_accuracy.pdf`
- `D2_axis_feature_recovery.png`
- `D2_axis_feature_recovery.pdf`
- `D3_axis_preference_guardrail.png`
- `D3_axis_preference_guardrail.pdf`
- `D4_edge_parallel_stability.png`
- `D4_edge_parallel_stability.pdf`
- `D5_objective_alignment_guardrail.png`
- `D5_objective_alignment_guardrail.pdf`
- `panel_D_axis_conditioned_values.csv`
- `panel_D_axis_feature_recovery_values.csv`
