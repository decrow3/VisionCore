...
continuous tau + interactions:         0.2213
true tau + interactions:               0.3289
0x stabilized response:                0.5070
known-eye model response:               0.4287
```

Primary paired contrast:

```text
continuous tau - 0x stabilized: -0.2857  CI [-0.3686, -0.2308]
```
