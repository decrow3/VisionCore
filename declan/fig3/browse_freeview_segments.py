"""Web browser for picking a free-viewing eye-trace segment for fig3 panel A.
...
Usage:
    uv run declan/fig3/browse_freeview_segments.py [--port 8787] [--host 0.0.0.0]
"""
...
<html><head><meta charset="utf-8"><title>fig3 freeview picker</title>
<style>
...
<h2 style="margin:4px 0 8px">Free-viewing segment picker — fig3 panel A</h2>
<div class="row">
