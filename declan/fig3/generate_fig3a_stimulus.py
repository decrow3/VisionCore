"""Standalone PDF/PNG render of the stimulus half of Figure 3 panel A.
...
Usage:
    uv run declan/fig3/generate_fig3a_stimulus.py [--recompute]
"""
...
from _fig3a_stimulus import plot_panel_a_stimulus, CANVAS_W, CANVAS_H
