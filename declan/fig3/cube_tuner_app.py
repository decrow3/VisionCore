...
back into _fig3a_stimulus.py module constants.

Usage:
    uv run python declan/fig3/cube_tuner_app.py
...
from _fig3a_data import load_panel_a_assets                       # noqa: E402
import _fig3a_stimulus as stim                                    # noqa: E402
...
<h3>Copy these into <code>_fig3a_stimulus.py</code>:</h3>
