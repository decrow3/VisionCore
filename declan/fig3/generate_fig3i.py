"""Figure 3 panel I: single-trial r^2, behavior-ablated vs intact twin.

Points on the unity line = removing the extraretinal behavior input does not
change the twin's single-trial prediction.

Usage:
    uv run declan/fig3/generate_fig3i.py [--cond zeroed|permuted]
"""
import argparse
import numpy as np
...
if __name__ == "__main__":
    p = argparse.ArgumentParser(description="Figure 3 panel I.")
