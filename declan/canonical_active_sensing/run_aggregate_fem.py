"""Run the canonical aggregate BackImage FEM response/decode job."""
...
TARGET_MODULE = "declan.fixation_statistics_by_stimulus.run_backimage_aggregate_fem_information"


def main() -> None:
    parser = argparse.ArgumentParser(description=__doc__)
    add_common_wrapper_args(parser, default_config=DEFAULT_CONFIG, default_section="aggregate_fem")
