"""Run canonical local I_z pairing jobs from config."""
...
DEFAULT_CONFIG = Path(__file__).resolve().parent / "configs" / "local_pairing_k16_v1.json"
TARGET_MODULE = "declan.fixation_statistics_by_stimulus.run_backimage_local_pairing_Iz_revisit"


def main() -> None:
    parser = argparse.ArgumentParser(description=__doc__)
    add_common_wrapper_args(parser, default_config=DEFAULT_CONFIG, default_section="local_pairing_primary")
