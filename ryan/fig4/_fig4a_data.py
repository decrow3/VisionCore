"""Asset loader for figure 4 panel A schematic.
...
from _fig4_data import CACHE_DIR
...
def load_panel_a_assets(recompute: bool = False) -> PanelAAssets:
    ...
    print(f"Loading raw session {PANEL_B_SESSION} for fig4a assets...")
    ...
    with open(PANEL_A_CACHE_PATH, "wb") as f:
        dill.dump(assets, f)
    print(f"Cached fig4a assets to {PANEL_A_CACHE_PATH}")
    return assets
