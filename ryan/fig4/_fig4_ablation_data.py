"""Ablation data loader for figure 4 bottom row (panels G/H/I).
...
is read from `fig2_decomposition.pkl` via `_fig4_data._load_fig2_alpha_by_session`.
"""
import sys
...
def print_ablation_stats(data=None):
    ...
    good = data["good"]
    print("\n=== Fig 4 bottom row — ablation cost (good cells, single-trial r^2) ===")
