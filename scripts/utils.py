...
def get_model_and_dataset_configs(mode='standard'):
    ...
    if mode == 'standard':
        dataset_configs_path = VISIONCORE_ROOT / "experiments/dataset_configs/multi_basic_120_long_legacy.yaml"
        ...
        model, model_info = load_model(
            ...
            cfg_dir_override=str(VISIONCORE_ROOT / "experiments/dataset_configs/multi_basic_120_long_legacy.yaml"),
            device='cpu'
        )
