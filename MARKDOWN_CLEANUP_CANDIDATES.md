...
First pass completed 2026-06-20:

- `declan/archive/superseded_handoffs/`
- `declan/archive/early_bigpicture/`
- `declan/archive/temporal_decoding/`
...
| --- | --- | --- | --- |
| Archived | `declan/archive/temporal_decoding/temporal_decoding_analysis_plan_consolidated_v2.md`, `declan/archive/temporal_decoding/temporal_decoding_analysis_implementation_plan.md`, `declan/archive/temporal_decoding/temporal_decoding_diagnostic_plan.md`, `declan/archive/temporal_decoding/temporal_analysis_issues_and_alternatives.md` | Old temporal-decoding planning cluster; current Figure 5/active-sensing framing moved elsewhere. | Completed 2026-06-20. |
| Archived | `declan/archive/early_bigpicture/bigpicture_phase1_fem_v1_coding_agent_plan_v2.md`, `declan/archive/early_bigpicture/bigpicture_fem_v1_high_impact_analysis_plan_v2.md`, `declan/archive/early_bigpicture/revised_analysis_plan.md`, `declan/archive/early_bigpicture/results_summary.md` | Broad early FEM planning/results docs. Later manifest/narrative encode current status and closed branches. | Completed 2026-06-20. |
| Archived | `declan/archive/jacobian_early/jacobian_identity_transformation_analysis_plan.md`, `declan/archive/jacobian_early/analysis_plan_jacobian_v3.md`, `declan/archive/jacobian_early/jacobian_predictive_framework_handoff_revised.md`, `declan/archive/jacobian_early/jacobian_figure_handoff_nature_style.md`, `declan/archive/jacobian_early/jacobian_predictive_framework_progress_summary.md`, `declan/archive/jacobian_early/jacobian_identity_geometry_results.md` | Older Jacobian planning and handoff cluster; useful historical guardrails but not default agent context. | Completed 2026-06-20. |
| Archived | `declan/archive/superseded_handoffs/Keystone_Geometry_Crossover_handoff_v2.md` | Superseded by `Keystone_Geometry_Crossover_handoff_v3.md`. | Completed 2026-06-20. |
| Archived | `declan/archive/superseded_handoffs/shared_transformation_geometry_handoff.md` | Superseded by `shared_transformation_geometry_handoff_v2.md` and later compact geometry docs. | Completed 2026-06-20. |
| Archived | `declan/archive/backimage_latent/Global Iz FEMs.md` | Backup/older note; aggregate FEM information plan is the current route. | Completed 2026-06-20. |
| Archived | `declan/archive/general_info_framework/A General Info Framework for FEM Functio.md` | Contains "Do not promote" signal; not current agent context. | Completed 2026-06-20. |
| Archived | `declan/archive/eoptotype/FEMs_Eoptotype_checks.md`, `declan/archive/eoptotype/fem_eoptotype_hyperacuity_results.md` | E-optotype branch is repeatedly marked historical/debugging for current Figure 5/active-sensing use. | Completed 2026-06-20. |
| Archived | `scripts/archive/notes/curvature_onset_fem_scale_match_plan.md`, `scripts/archive/notes/pipeline_hypotheses.md`, `scripts/archive/notes/Inclusion.md` | Older script-adjacent plans; should not be default context. | Completed 2026-06-20. |
...
| Archived | `docs/archive/model_experiments/polar_v1_*`, `docs/archive/model_experiments/POLAR_V1_*`, `docs/archive/model_experiments/README_POLAR_V1.md`, `docs/archive/model_experiments/VIVIT_*` | Older model-design docs, potentially useful if those modules return. | Completed 2026-06-20; code/configs were not moved. |
